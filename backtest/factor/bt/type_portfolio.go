...
func (s *S포트폴리오) S리밸런싱_실행(종목코드_모음 []string) error {
	...
	for 종목코드, 보유_수량 := range s.M보유_현황.M주식 {
		...
		s.s주식_매도(종목코드, 보유_수량, 가격, P리밸런싱_매도)
	}
...
func (s *S포트폴리오) s주식_매수(종목코드 string, 수량 int64, 가격 float64, 매매_상세_구분 T매매_상세_구분) {
	s.s주식_주문(종목코드, lib.P매수, 수량, 가격, 매매_상세_구분)
}

func (s *S포트폴리오) s주식_매도(종목코드 string, 수량 int64, 가격 float64, 매매_상세_구분 T매매_상세_구분) {
	s.s주식_주문(종목코드, lib.P매도, 수량, 가격, 매매_상세_구분)
}

func (s *S포트폴리오) s주식_주문(종목코드 string, 매도_매수_구분 lib.T매도_매수_구분, 수량 int64, 가격 float64, 매매_상세_구분 T매매_상세_구분) {
