...
func (this s모의_테스트) Errorf(format string, args ...interface{}) { 모의_테스트_통과 = false }
...
func (this s모의_테스트) Fatalf(format string, args ...interface{}) { 모의_테스트_통과 = false }
...
func TestF체크포인트(테스트 *testing.T) {
	...
	F테스트_참임(테스트, strings.Contains(버퍼.String(), "ghts/shared.TestF체크포인트() 체크포인트 1 : 테스트_문자열, 1\n"))
