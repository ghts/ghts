...
func F종목코드_추출(종목_모음 []*S종목, 수량 int) (추출_코드_모음 []string) {
	defer S예외처리{M함수: func() { 추출_코드_모음 = nil }}.S실행()
...
func F샘플_종목_모음_코스피_주식() []*S종목 {
	...
	종목_모음 = append(종목_모음, New종목("000030", "우리은행", P시장구분_코스피))
	...
	종목_모음 = append(종목_모음, New종목("018260", "삼성SDS", P시장구분_코스피))
...
func F샘플_종목_모음_코스닥_주식() []*S종목 {
	...
	종목_모음 = append(종목_모음, New종목("130960", "CJ E&M", P시장구분_코스닥))
	종목_모음 = append(종목_모음, New종목("086900", "메디톡스", P시장구분_코스닥))
	종목_모음 = append(종목_모음, New종목("084990", "바이로메드", P시장구분_코스닥))
	종목_모음 = append(종목_모음, New종목("034230", "파라다이스", P시장구분_코스닥))
	종목_모음 = append(종목_모음, New종목("016170", "로엔", P시장구분_코스닥))
	...
	종목_모음 = append(종목_모음, New종목("035760", "CJ오쇼핑", P시장구분_코스닥))
	종목_모음 = append(종목_모음, New종목("084110", "휴온스", P시장구분_코스닥))
	종목_모음 = append(종목_모음, New종목("046890", "서울반도체", P시장구분_코스닥))
	종목_모음 = append(종목_모음, New종목("096530", "씨젠", P시장구분_코스닥))
	종목_모음 = append(종목_모음, New종목("028150", "GS홈쇼핑", P시장구분_코스닥))
	종목_모음 = append(종목_모음, New종목("036490", "OCI머티리얼즈", P시장구분_코스닥))
...
func F샘플_종목_모음_코스피200_ETF() []*S종목 {
	종목_모음 := []*S종목{
		...
		New종목("152280", "KOSEF 200선물", P시장구분_ETF),
...
func F샘플_종목_모음_ETF() []*S종목 {
	...
	종목_모음 = append(종목_모음, New종목("091210", "TIGER KRX100", P시장구분_ETF))
	종목_모음 = append(종목_모음, New종목("091220", "TIGER 은행", P시장구분_ETF))
	종목_모음 = append(종목_모음, New종목("091230", "TIGER 반도체", P시장구분_ETF))
	종목_모음 = append(종목_모음, New종목("097710", "TIGER 가치주", P시장구분_ETF))
	종목_모음 = append(종목_모음, New종목("097720", "TIGER 미드캡", P시장구분_ETF))
	종목_모음 = append(종목_모음, New종목("097750", "TREX 중소형가치", P시장구분_ETF))
	종목_모음 = append(종목_모음, New종목("098560", "TIGER 미디어통신", P시장구분_ETF))
	종목_모음 = append(종목_모음, New종목("099140", "KODEX China H", P시장구분_ETF))
	종목_모음 = append(종목_모음, New종목("100910", "KOSEF KRX100", P시장구분_ETF))
	종목_모음 = append(종목_모음, New종목("101280", "KODEX Japan", P시장구분_ETF))
	종목_모음 = append(종목_모음, New종목("102110", "TIGER 200", P시장구분_ETF))
	종목_모음 = append(종목_모음, New종목("102780", "KODEX 삼성그룹", P시장구분_ETF))
	종목_모음 = append(종목_모음, New종목("102960", "KODEX 조선", P시장구분_ETF))
	...
	종목_모음 = append(종목_모음, New종목("105010", "TIGER 라틴", P시장구분_ETF))
	종목_모음 = append(종목_모음, New종목("105190", "KINDEX 200", P시장구분_ETF))
	종목_모음 = append(종목_모음, New종목("105270", "KINDEX 성장대형F15", P시장구분_ETF))
	종목_모음 = append(종목_모음, New종목("105780", "KStar 5대그룹주", P시장구분_ETF))
	종목_모음 = append(종목_모음, New종목("107560", "GIANT 현대차그룹", P시장구분_ETF))
	종목_모음 = append(종목_모음, New종목("108440", "KINDEX 코스닥스타", P시장구분_ETF))
	종목_모음 = append(종목_모음, New종목("108450", "KINDEX 삼성그룹SW", P시장구분_ETF))
	종목_모음 = append(종목_모음, New종목("108480", "KStar 코스닥엘리트", P시장구분_ETF))
	종목_모음 = append(종목_모음, New종목("108590", "TREX 200", P시장구분_ETF))
	종목_모음 = append(종목_모음, New종목("108630", "FIRST 스타우량", P시장구분_ETF))
	...
	종목_모음 = append(종목_모음, New종목("123760", "KStar 레버리지", P시장구분_ETF))
	...
	종목_모음 = append(종목_모음, New종목("136280", "KODEX 소비재", P시장구분_ETF))
	...
	종목_모음 = append(종목_모음, New종목("137990", "TIGER 그린", P시장구분_ETF))
	...
	종목_모음 = append(종목_모음, New종목("141240", "ARIRANG K100EW", P시장구분_ETF))
	...
	종목_모음 = append(종목_모음, New종목("148040", "PIONEER SRI", P시장구분_ETF))
	...
	종목_모음 = append(종목_모음, New종목("152180", "TIGER 생활필수품", P시장구분_ETF))
	종목_모음 = append(종목_모음, New종목("152280", "KOSEF 200 선물", P시장구분_ETF))
	...
	종목_모음 = append(종목_모음, New종목("157510", "TIGER 자동차", P시장구분_ETF))
	종목_모음 = append(종목_모음, New종목("157520", "TIGER 화학", P시장구분_ETF))
	종목_모음 = append(종목_모음, New종목("157650", "KStar 5대그룹주 장기", P시장구분_ETF))
	종목_모음 = append(종목_모음, New종목("159800", "마이티 K100", P시장구분_ETF))
	종목_모음 = append(종목_모음, New종목("160580", "TIGER 구리실물", P시장구분_ETF))
	종목_모음 = append(종목_모음, New종목("161490", "ARIRANG 방어주", P시장구분_ETF))
	종목_모음 = append(종목_모음, New종목("161500", "ARIRANG 주도주", P시장구분_ETF))
	...
	종목_모음 = append(종목_모음, New종목("170350", "TIGER 베타플러스", P시장구분_ETF))
	...
	종목_모음 = append(종목_모음, New종목("181450", "KINDEX 선진국 하이일드", P시장구분_ETF))
	...
	종목_모음 = append(종목_모음, New종목("190150", "ARIRANG 바벨 채권", P시장구분_ETF))
	종목_모음 = append(종목_모음, New종목("190160", "ARIRANG 단기유동성", P시장구분_ETF))
	...
	종목_모음 = append(종목_모음, New종목("200020", "KODEX 미국IT(합성)", P시장구분_ETF))
	종목_모음 = append(종목_모음, New종목("200030", "KODEX 미국산업재(합성)", P시장구분_ETF))
	종목_모음 = append(종목_모음, New종목("200040", "KODEX 미국금융(합성)", P시장구분_ETF))
	종목_모음 = append(종목_모음, New종목("200050", "KODEX MSCI독일(합성)", P시장구분_ETF))
	종목_모음 = append(종목_모음, New종목("200250", "KOSEF 인디아(합성)", P시장구분_ETF))
	종목_모음 = append(종목_모음, New종목("203780", "TIGER 나스닥 바이오", P시장구분_ETF))
	종목_모음 = append(종목_모음, New종목("204420", "ARIRANG 차이나H 레버리지", P시장구분_ETF))
	...
	종목_모음 = append(종목_모음, New종목("211210", "마이티 코스피 고배당", P시장구분_ETF))
	종목_모음 = append(종목_모음, New종목("211260", "KINDEX 배당성장", P시장구분_ETF))
	...
	종목_모음 = append(종목_모음, New종목("217770", "TIGER 원유선물 인버스, TIGER 원유 인버스", P시장구분_ETF))
	...
	종목_모음 = append(종목_모음, New종목("222170", "ARIRANG S&P 배당성장", P시장구분_ETF))
	종목_모음 = append(종목_모음, New종목("222180", "ARIRANG 스마트베타 V", P시장구분_ETF))
	종목_모음 = append(종목_모음, New종목("222190", "ARIRANG 스마트베타 M", P시장구분_ETF))
	종목_모음 = append(종목_모음, New종목("222200", "ARIRANG 스마트베타 Q", P시장구분_ETF))
	...
	종목_모음 = append(종목_모음, New종목("226810", "파워 단기채", P시장구분_ETF))
	종목_모음 = append(종목_모음, New종목("226980", "KODEX 200 중소형", P시장구분_ETF))
	종목_모음 = append(종목_모음, New종목("227540", "TIGER 200 건강관리", P시장구분_ETF))
	...
	종목_모음 = append(종목_모음, New종목("227930", "KINDEX 코스닥 150", P시장구분_ETF))
