...
func New영업일_모음(db *sql.DB) *S영업일_모음 {
	일일_가격정보_모음_KODEX200 := new(lib.S종목별_일일_가격정보_모음)
	lib.F확인(일일_가격정보_모음_KODEX200.DB읽기(db, "069500"))

	일일_가격정보_모음_삼성전자 := new(lib.S종목별_일일_가격정보_모음)
	lib.F확인(일일_가격정보_모음_삼성전자.DB읽기(db, "005930"))
