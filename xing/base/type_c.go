...
type T1101OutBlock struct {
	...
	Krx_midprice         [8]byte
	X_krx_midprice       byte
	Krx_offermidsumrem   [9]byte
	X_krx_offermidsumrem byte
	Krx_bidmidsumrem     [9]byte
	X_krx_bidmidsumrem   byte
	Krx_midsumrem        [9]byte
	X_krx_midsumrem      byte
	Krx_midsumremgubun   [1]byte
	X_krx_midsumremgubun byte
}
...
type T1102OutBlock struct {
	...
	Ty_text              [8]byte
	X_ty_text            byte
	Nxt_janginfo         [10]byte
	X_nxt_janginfo       byte
	Nxt_shterm_text      [10]byte
	X_nxt_shterm_text    byte
	Nxt_svi_uplmtprice   [8]byte
	X_nxt_svi_uplmtprice byte
	Nxt_svi_dnlmtprice   [8]byte
...
type H1_OutBlock struct {
	...
	Midsumrem        [9]byte
	X_midsumrem      byte
	Midsumremgubun   [1]byte
	X_midsumremgubun byte
}
