...
func F바이트_변환값_해석(바이트_변환값 *lib.S바이트_변환) (해석값 interface{}, 에러 error) {
	...
	case P자료형_CSPAT00700_현물_정정_주문_질의값:
		...
		lib.F확인(바이트_변환값.G값(s))
		return s, nil
	case P자료형_T0150_현물_당일_매매일지_수수료_질의값:
		s := new(T0150_현물_당일_매매일지_수수료_질의값)
		lib.F확인(바이트_변환값.G값(s))
		return s, nil
	case P자료형_T0151_현물_전일_매매일지_수수료_질의값:
		s := new(T0151_현물_전일_매매일지_수수료_질의값)
		lib.F확인(바이트_변환값.G값(s))
		return s, nil
	...
	case P자료형_T8436_현물_종목조회_응답_반복값:
		...
		lib.F확인(바이트_변환값.G값(s))
		return s, nil
	case P자료형_T8436_현물_종목조회_응답_반복값_모음:
		s := new(T8436_현물_종목조회_응답_반복값_모음)
		lib.F확인(바이트_변환값.G값(s))
		return s, nil
	}
...
func F바이트_변환값_해석_Raw(바이트_변환값 *lib.S바이트_변환) (해석값 interface{}, 에러 error) {
	...
	case P자료형_T0150_현물_당일_매매일지_수수료_응답:
		return NewT0150_현물_당일_매매일지_수수료_응답(b)
	case P자료형_T0150OutBlock:
		return NewT0150_현물_당일_매매일지_수수료_응답_헤더(b)
	case P자료형_T0150OutBlock1:
		return NewT0150_현물_당일_매매일지_수수료_응답_반복값_모음(b)
	case P자료형_T0151OutBlock:
		return NewT0151_현물_전일_매매일지_수수료_응답_헤더(b)
	case P자료형_T0151OutBlock1:
		return NewT0151_현물_전일_매매일지_수수료_응답_반복값_모음(b)
