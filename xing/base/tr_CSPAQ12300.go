...
func NewCSPAQ12300_현물계좌_잔고내역_응답(b []byte) (값 *CSPAQ12300_현물계좌_잔고내역_응답, 에러 error) {
	...
	값.M헤더1 = lib.F확인2(NewCSPAQ12300_현물계좌_잔고내역_조회_응답_헤더1(b[:SizeCSPAQ12300OutBlock1]))
	...
	값.M반복값_모음 = lib.F확인2(NewCSPAQ12300_현물계좌_잔고내역_조회_응답_반복값_모음(b))
...
//	값.M레코드_수량 = lib.F확인2(lib.F2정수64(g.RecCnt)
//	값.M지점명 = lib.F2문자열_EUC_KR_공백제거(g.BrnNm)
//	값.M계좌명 = lib.F2문자열_EUC_KR_공백제거(g.AcntNm)
//	값.M현금주문가능금액 = lib.F확인2(lib.F2정수64(g.MnyOrdAbleAmt)
//	값.M출금가능금액 = lib.F확인2(lib.F2정수64(g.MnyoutAbleAmt)
//	값.M거래소금액 = lib.F확인2(lib.F2정수64(g.SeOrdAbleAmt)
//	값.M코스닥금액 = lib.F확인2(lib.F2정수64(g.KdqOrdAbleAmt)
//	값.HTS주문가능금액 = lib.F확인2(lib.F2정수64(g.HtsOrdAbleAmt)
//	값.M증거금률100퍼센트주문가능금액 = lib.F확인2(lib.F2정수64(g.MgnRat100pctOrdAbleAmt)
//	값.M잔고평가금액 = lib.F확인2(lib.F2정수64(g.BalEvalAmt)
//	값.M매입금액 = lib.F확인2(lib.F2정수64(g.PchsAmt)
//	값.M미수금액 = lib.F확인2(lib.F2정수64(g.RcvblAmt)
//	값.M손익율 = lib.F확인2(lib.F2실수_소숫점_추가(g.PnlRat, 6)
//	값.M투자원금 = lib.F확인2(lib.F2정수64(g.InvstOrgAmt)
//	값.M투자손익금액 = lib.F확인2(lib.F2정수64(g.InvstPlAmt)
//	값.M신용담보주문금액 = lib.F확인2(lib.F2정수64(g.CrdtPldgOrdAmt)
//	값.M예수금 = lib.F확인2(lib.F2정수64(g.Dps)
//	값.D1예수금 = lib.F확인2(lib.F2정수64(g.D1Dps)
//	값.D2예수금 = lib.F확인2(lib.F2정수64(g.D2Dps)
//	값.M주문일 = lib.F2포맷된_일자_단순형_공백은_초기값("20060102", g.OrdDt)
//	값.M현금증거금액 = lib.F확인2(lib.F2정수64(g.MnyMgn)
//	값.M대용증거금액 = lib.F확인2(lib.F2정수64(g.SubstMgn)
//	값.M대용금액 = lib.F확인2(lib.F2정수64(g.SubstAmt)
//	값.M전일매수체결금액 = lib.F확인2(lib.F2정수64(g.PrdayBuyExecAmt)
//	값.M전일매도체결금액 = lib.F확인2(lib.F2정수64(g.PrdaySellExecAmt)
//	값.M금일매수체결금액 = lib.F확인2(lib.F2정수64(g.CrdayBuyExecAmt)
//	값.M금일매도체결금액 = lib.F확인2(lib.F2정수64(g.CrdaySellExecAmt)
//	값.M평가손익합계 = lib.F확인2(lib.F2정수64(g.EvalPnlSum)
//	값.M예탁자산총액 = lib.F확인2(lib.F2정수64(g.DpsastTotamt)
//	값.M제비용 = lib.F확인2(lib.F2정수64(g.Evrprc)
//	값.M재사용금액 = lib.F확인2(lib.F2정수64(g.RuseAmt)
//	값.M기타대여금액 = lib.F확인2(lib.F2정수64(g.EtclndAmt)
//	값.M가정산금액 = lib.F확인2(lib.F2정수64(g.PrcAdjstAmt)
//	값.D1수수료 = lib.F확인2(lib.F2정수64(g.D1CmsnAmt)
//	값.D2수수료 = lib.F확인2(lib.F2정수64(g.D2CmsnAmt)
//	값.D1제세금 = lib.F확인2(lib.F2정수64(g.D1EvrTax)
//	값.D2제세금 = lib.F확인2(lib.F2정수64(g.D2EvrTax)
//	값.D1결제예정금액 = lib.F확인2(lib.F2정수64(g.D1SettPrergAmt)
//	값.D2결제예정금액 = lib.F확인2(lib.F2정수64(g.D2SettPrergAmt)
//	값.M전일KSE현금증거금 = lib.F확인2(lib.F2정수64(g.PrdayKseMnyMgn)
//	값.M전일KSE대용증거금 = lib.F확인2(lib.F2정수64(g.PrdayKseSubstMgn)
//	값.M전일KSE신용현금증거금 = lib.F확인2(lib.F2정수64(g.PrdayKseCrdtMnyMgn)
//	값.M전일KSE신용대용증거금 = lib.F확인2(lib.F2정수64(g.PrdayKseCrdtSubstMgn)
//	값.M금일KSE현금증거금 = lib.F확인2(lib.F2정수64(g.CrdayKseMnyMgn)
//	값.M금일KSE대용증거금 = lib.F확인2(lib.F2정수64(g.CrdayKseSubstMgn)
//	값.M금일KSE신용현금증거금 = lib.F확인2(lib.F2정수64(g.CrdayKseCrdtMnyMgn)
//	값.M금일KSE신용대용증거금 = lib.F확인2(lib.F2정수64(g.CrdayKseCrdtSubstMgn)
//	값.M전일코스닥현금증거금 = lib.F확인2(lib.F2정수64(g.PrdayKdqMnyMgn)
//	값.M전일코스닥대용증거금 = lib.F확인2(lib.F2정수64(g.PrdayKdqSubstMgn)
//	값.M전일코스닥신용현금증거금 = lib.F확인2(lib.F2정수64(g.PrdayKdqCrdtMnyMgn)
//	값.M전일코스닥신용대용증거금 = lib.F확인2(lib.F2정수64(g.PrdayKdqCrdtSubstMgn)
//	값.M금일코스닥현금증거금 = lib.F확인2(lib.F2정수64(g.CrdayKdqMnyMgn)
//	값.M금일코스닥대용증거금 = lib.F확인2(lib.F2정수64(g.CrdayKdqSubstMgn)
//	값.M금일코스닥신용현금증거금 = lib.F확인2(lib.F2정수64(g.CrdayKdqCrdtMnyMgn)
//	값.M금일코스닥신용대용증거금 = lib.F확인2(lib.F2정수64(g.CrdayKdqCrdtSubstMgn)
//	값.M전일프리보드현금증거금 = lib.F확인2(lib.F2정수64(g.PrdayFrbrdMnyMgn)
//	값.M전일프리보드대용증거금 = lib.F확인2(lib.F2정수64(g.PrdayFrbrdSubstMgn)
//	값.M금일프리보드현금증거금 = lib.F확인2(lib.F2정수64(g.CrdayFrbrdMnyMgn)
//	값.M금일프리보드대용증거금 = lib.F확인2(lib.F2정수64(g.CrdayFrbrdSubstMgn)
//	값.M전일장외현금증거금 = lib.F확인2(lib.F2정수64(g.PrdayCrbmkMnyMgn)
//	값.M전일장외대용증거금 = lib.F확인2(lib.F2정수64(g.PrdayCrbmkSubstMgn)
//	값.M금일장외현금증거금 = lib.F확인2(lib.F2정수64(g.CrdayCrbmkMnyMgn)
//	값.M금일장외대용증거금 = lib.F확인2(lib.F2정수64(g.CrdayCrbmkSubstMgn)
//	값.M예탁담보수량 = lib.F확인2(lib.F2정수64(g.DpspdgQty)
//	값.M매수정산금_D_2 = lib.F확인2(lib.F2정수64(g.BuyAdjstAmtD2)
//	값.M매도정산금_D_2 = lib.F확인2(lib.F2정수64(g.SellAdjstAmtD2)
//	값.M변제소요금_D_1 = lib.F확인2(lib.F2정수64(g.RepayRqrdAmtD1)
//	값.M변제소요금_D_2 = lib.F확인2(lib.F2정수64(g.RepayRqrdAmtD2)
//	값.M대출금액 = lib.F확인2(lib.F2정수64(g.LoanAmt)
//
//	return 값, nil
//}
...
func NewCSPAQ12300_현물계좌_잔고내역_조회_응답_반복값_모음(b []byte) (값_모음 []*CSPAQ12300_현물계좌_잔고내역_응답_반복값, 에러 error) {
	...
	for i, g := range g_모음 {
		...
		값.M종목코드 = strings.Replace(lib.F2문자열_공백_제거(g.IsuNo), "A", "", 1)
		...
		값.M매매기준잔고수량 = lib.F확인2(lib.F2정수64(g.BnsBaseBalQty))
		값.M금일매수체결수량 = lib.F확인2(lib.F2정수64(g.CrdayBuyExecQty))
		값.M금일매도체결수량 = lib.F확인2(lib.F2정수64(g.CrdaySellExecQty))
		값.M매도가 = lib.F확인2(lib.F2실수_소숫점_추가(g.SellPrc, 4))
		값.M매수가 = lib.F확인2(lib.F2실수_소숫점_추가(g.BuyPrc, 4))
		값.M매도손익금액 = lib.F확인2(lib.F2정수64(g.SellPnlAmt))
		값.M손익율 = lib.F확인2(lib.F2실수_소숫점_추가(g.PnlRat, 6))
		...
		값.M전일매도체결금액 = lib.F확인2(lib.F2정수64(g.PrdaySellExecAmt))
		값.M잔고평가금액 = lib.F확인2(lib.F2정수64(g.BalEvalAmt))
		값.M평가손익 = lib.F확인2(lib.F2정수64(g.EvalPnl))
		값.M현금주문가능금액 = lib.F확인2(lib.F2정수64(g.MnyOrdAbleAmt))
		값.M주문가능금액 = lib.F확인2(lib.F2정수64(g.OrdAbleAmt))
		값.M매도미체결수량 = lib.F확인2(lib.F2정수64(g.SellUnercQty))
		값.M매도미결제수량 = lib.F확인2(lib.F2정수64(g.SellUnsttQty))
		값.M매수미체결수량 = lib.F확인2(lib.F2정수64(g.BuyUnercQty))
		값.M매수미결제수량 = lib.F확인2(lib.F2정수64(g.BuyUnsttQty))
		값.M미결제수량 = lib.F확인2(lib.F2정수64(g.UnsttQty))
