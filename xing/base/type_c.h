...
typedef struct {
    ...
    char    MbrNo               [   3];    // [string,    3] 회원사번호                      StartPos 84, Length 3
} CSPAT00600InBlock1;
...
typedef struct {
 ...
 typedef struct {
    char    upgubunnm           [  40];    char    _upgubunnm           ;    // [string,   40] 업종구분명                      StartPos 0, Length 40
    char    sijangcd            [   1];    char    _sijangcd            ;    // [string,    1] 시장구분                        StartPos 41, Length 1
    char    marketnm            [  10];    char    _marketnm            ;    // [string,   10] 시장구분명                      StartPos 43, Length 10
    char    company             [ 100];    char    _company             ;    // [string,  100] 한글기업명                      StartPos 54, Length 100
    char    baddress            [ 100];    char    _baddress            ;    // [string,  100] 본사주소                        StartPos 155, Length 100
    char    btelno              [  20];    char    _btelno              ;    // [string,   20] 본사전화번호                    StartPos 256, Length 20
    char    gsyyyy              [   4];    char    _gsyyyy              ;    // [string,    4] 최근결산년도                    StartPos 277, Length 4
    char    gsmm                [   2];    char    _gsmm                ;    // [string,    2] 결산월                          StartPos 282, Length 2
    char    gsym                [   6];    char    _gsym                ;    // [string,    6] 최근결산년월                    StartPos 285, Length 6
    char    lstprice            [  12];    char    _lstprice            ;    // [long  ,   12] 주당액면가                      StartPos 292, Length 12
    char    gstock              [  12];    char    _gstock              ;    // [long  ,   12] 주식수                          StartPos 305, Length 12
    char    homeurl             [  50];    char    _homeurl             ;    // [string,   50] Homepage                        StartPos 318, Length 50
    char    grdnm               [  30];    char    _grdnm               ;    // [string,   30] 그룹명                          StartPos 369, Length 30
    char    foreignratio        [   6];    char    _foreignratio        ;    // [double,  6.2] 외국인                          StartPos 400, Length 6
    char    irtel               [  30];    char    _irtel               ;    // [string,   30] 주담전화                        StartPos 407, Length 30
    char    capital             [  12];    char    _capital             ;    // [double,   12] 자본금                          StartPos 438, Length 12
    char    sigavalue           [  12];    char    _sigavalue           ;    // [double,   12] 시가총액                        StartPos 451, Length 12
    char    cashsis             [  12];    char    _cashsis             ;    // [double,   12] 배당금                          StartPos 464, Length 12
    char    cashrate            [  13];    char    _cashrate            ;    // [double, 13.2] 배당수익율                      StartPos 477, Length 13
    char    price               [   8];    char    _price               ;    // [long  ,    8] 현재가                          StartPos 491, Length 8
    char    jnilclose           [   8];    char    _jnilclose           ;    // [long  ,    8] 전일종가                        StartPos 500, Length 8
    char    notice1             [   1];    char    _notice1             ;    // [string,    1] 위험고지구분1_정리매매          StartPos 509, Length 1
    char    notice2             [   1];    char    _notice2             ;    // [string,    1] 위험고지구분2_투자위험          StartPos 511, Length 1
    char    notice3             [   1];    char    _notice3             ;    // [string,    1] 위험고지구분3_단기과열          StartPos 513, Length 1
} T3320OutBlock;
...
typedef struct {
    ...
    char    per                 [  13];    char    _per                 ;    // [double, 13.2] PER                             StartPos 17, Length 13
    char    eps                 [  13];    char    _eps                 ;    // [double,   13] EPS                             StartPos 31, Length 13
    char    pbr                 [  13];    char    _pbr                 ;    // [double, 13.2] PBR                             StartPos 45, Length 13
    char    roa                 [  13];    char    _roa                 ;    // [double, 13.2] ROA                             StartPos 59, Length 13
    char    roe                 [  13];    char    _roe                 ;    // [double, 13.2] ROE                             StartPos 73, Length 13
    char    ebitda              [  13];    char    _ebitda              ;    // [double, 13.2] EBITDA                          StartPos 87, Length 13
    char    evebitda            [  13];    char    _evebitda            ;    // [double, 13.2] EVEBITDA                        StartPos 101, Length 13
    char    par                 [  13];    char    _par                 ;    // [double, 13.2] 액면가                          StartPos 115, Length 13
    char    sps                 [  13];    char    _sps                 ;    // [double, 13.2] SPS                             StartPos 129, Length 13
    char    cps                 [  13];    char    _cps                 ;    // [double, 13.2] CPS                             StartPos 143, Length 13
    char    bps                 [  13];    char    _bps                 ;    // [double,   13] BPS                             StartPos 157, Length 13
    char    t_per               [  13];    char    _t_per               ;    // [double, 13.2] T.PER                           StartPos 171, Length 13
    char    t_eps               [  13];    char    _t_eps               ;    // [double,   13] T.EPS                           StartPos 185, Length 13
    char    peg                 [  13];    char    _peg                 ;    // [double, 13.2] PEG                             StartPos 199, Length 13
    char    t_peg               [  13];    char    _t_peg               ;    // [double, 13.2] T.PEG                           StartPos 213, Length 13
