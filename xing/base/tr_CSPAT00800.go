...
func NewCSPAT00800_현물_취소_주문_응답2(b []byte) (s *CSPAT00800_S현물_취소_주문_응답2, 에러 error) {
	...
	s.M신용거래_코드 = T신용거래_구분(lib.F확인2(lib.F2정수64_공백은_0(g.MgntrnCode)))
	...
	s.M예비_주문번호 = lib.F확인2(lib.F2정수64_공백은_0(g.SpareOrdNo))
	s.M반대매매_일련번호 = lib.F확인2(lib.F2정수64_공백은_0(g.CvrgSeqno))
	s.M예약_주문번호 = lib.F확인2(lib.F2정수64_공백은_0(g.RsvOrdNo))
