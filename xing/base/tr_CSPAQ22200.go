...
func NewCSPAQ22200_현물계좌_예수금_주문가능금액_응답(b []byte) (값 *CSPAQ22200_현물계좌_예수금_주문가능금액_응답, 에러 error) {
	...
	값.M지점명 = lb.F2문자열_EUC_KR_공백제거(g2.BrnNm)
	...
	값.M코스피금액 = lb.F확인2(lb.F2정수64(g2.SeOrdAbleAmt))
	값.M코스닥금액 = lb.F확인2(lb.F2정수64(g2.KdqOrdAbleAmt))
	...
	값.D1_예수금 = lb.F확인2(lb.F2정수64(g2.D1Dps))
	값.D2_예수금 = lb.F확인2(lb.F2정수64(g2.D2Dps))
