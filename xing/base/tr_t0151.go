...
func TR_t0151_현물_전일_매매일지_수수료(일자 time.Time, 계좌번호 string) (응답값 *T0151_현물_전일_매매일지_수수료_응답, 에러 error) {
	panic("TODO")
}
...
type T0151_현물_전일_매매일지_수수료_응답 struct {
	M헤더     *T0151_현물_전일_매매일지_수수료_응답_헤더
	M반복값_모음 []*T0151_현물_전일_매매일지_수수료_응답_반복값
}

type T0151_현물_전일_매매일지_수수료_응답_헤더 struct {
	M매도_수량   int64
	M매도_약정금액 int64
	M매도_수수료  int64
	M매도_거래세  int64
...
type T0151_현물_전일_매매일지_수수료_응답_반복값 struct {
	M매매구분 string
	M종목코드 string
	M수량   int64
	M단가   int64
...
func NewT0151_현물_전일_매매일지_수수료_응답_헤더(b []byte) (값 *T0151_현물_전일_매매일지_수수료_응답_헤더, 에러 error) {
	...
	값 = new(T0151_현물_전일_매매일지_수수료_응답_헤더)
...
func NewT0151_현물_전일_매매일지_수수료_응답_반복값_모음(b []byte) (값_모음 []*T0151_현물_전일_매매일지_수수료_응답_반복값, 에러 error) {
	...
	for i, g := range g_모음 {
		...
		값 := new(T0151_현물_전일_매매일지_수수료_응답_반복값)
