...
func TestCFOAT00300_선물옵션_취소주문(t *testing.T) {
	...
	//lib.F테스트_에러없음(t, 에러)
	//
	//테스트_CFOAT00300_선물옵션_취소주문(t, 응답값, 계좌번호, 종목코드, 원주문번호, 취소수량)
}

func 테스트_CFOAT00300_선물옵션_취소주문(t *testing.T, 응답값 *xt.CFOAT00300_선물옵션_취소주문_응답,
	계좌번호, 종목코드 string, 원주문번호, 취소수량 int64) {
