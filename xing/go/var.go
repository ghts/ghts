...
var (
	소켓REP_TR콜백   nano.I소켓Raw
	소켓SUB_실시간_정보 lib.I소켓

	소켓REQ_저장소 = lib.New소켓_저장소(20, func() lib.I소켓_질의 {
		return nano.NewNano소켓REQ_단순형(xt.F주소_C32_호출(), lib.P30초)
	})
	...
	ch현물_정상_주문 = make(chan *xt.CSPAT00600_현물_정상_주문_질의_응답, 1000)
	ch현물_정정_주문 = make(chan *xt.CSPAT00700_현물_정정_주문_질의_응답, 1000)
	ch현물_취소_주문 = make(chan *xt.CSPAT00800_현물_취소_주문_질의_응답, 1000)
