...
func F초기화(서버_구분 xt.T서버_구분, 로그인_정보 *xt.S로그인_정보, 절전_모드_여부 ...bool) {
	절전_모드 := lib.F조건값(len(절전_모드_여부) == 1, 절전_모드_여부[0], false)
...
func f초기화_DLL32(절전_모드 bool) (에러 error) {
