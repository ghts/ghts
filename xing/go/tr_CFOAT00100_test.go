...
func TestCFOAT00100_선물옵션_정상주문(t *testing.T) {
	...
	종목코드 := 종목코드_1 + 종목코드_2_3 + 종목코드_4 + 종목코드_5 + 종목코드_6_7_8
	...
	var 응답값 *xt.CFOAT00100_선물옵션_정상주문_응답
	var 에러 error

	매매구분 := lib.P매수
	응답값, 에러 = TrCFOAT00100_선물옵션_정상주문(계좌번호, 종목코드, 매매구분, 호가유형, 주문가격, 주문수량)
	lib.F테스트_에러없음(t, 에러)
	테스트_CFOAT00100_선물옵션_정상주문(t, 응답값, 계좌번호, 종목코드, 매매구분, 호가유형, 주문가격, 주문수량)
...
func 테스트_CFOAT00100_선물옵션_정상주문(t *testing.T, 응답값 *xt.CFOAT00100_선물옵션_정상주문_응답,
	...
	lib.F테스트_같음(t, 값1.M매매구분, lib.P매수)
