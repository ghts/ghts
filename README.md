...
*********************************************************
<주의><br>
현재(2024년 6월) 기준 권장되는 Go언어 버전은 1.22 입니다.<br>
Go 1.19, 1.21, 1.22에서 정상적으로 작동하는 것이 확인되었습니다.
Go 1.18 및 1.20의 초기 버전에서는 문제가 발생할 수 있습니다.<br>
...
사용법 :go.mod 파일에 다음 행을 추가 후 'go mod tidy' 실행.

<pre><code>require github.com/ghts/ghts latest</code></pre>
