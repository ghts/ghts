...
*********************************************************
<주의><br>
Go언어 1.18부터 추가된 제너릭(generics) 기능을 적용한 이후, <br> 
Xing API초기화 과정에서 에러가 발생하고 종료되는 경우가 있습니다.

이렇게 종료될 때마다 재실행 시켜주는 외부 프로그램을 이용하면<br>
해당 문제에 어느 정도 대응할 수 있습니다.<br>

재시작 해주는 외부 프로세스 예제.
(재시작 할 실행화일의 경로를 '<실행화일_경로>'위치에 설정하면 됩니다.)
