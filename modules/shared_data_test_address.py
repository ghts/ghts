...
def 테스트용_주소정보_요청_모듈(P주소_주소정보, P주소_테스트_결과_회신, 테스트_반복횟수):
    ...
    질의값_모음 = []
    질의값_모음.append("P주소_주소정보")
    질의값_모음.append("P주소_종목정보")
    질의값_모음.append("P주소_가격정보_입수")
    질의값_모음.append("P주소_가격정보_배포")
    질의값_모음.append("P주소_가격정보")
    질의값_모음.append("P주소_테스트_결과_회신")
    
    테스트_결과 = True
    
    for 반복횟수 in range(테스트_반복횟수):
        질의값 = 질의값_모음[random.randint(0, len(질의값_모음) - 1)]
        메시지 = [P메시지_구분_일반.encode(UTF8), 질의값.encode(UTF8)]
...
if __name__ == "__main__":
    ...
    테스트용_주소정보_요청_모듈(P주소_주소정보, P주소_테스트_결과_회신, 테스트_반복횟수)