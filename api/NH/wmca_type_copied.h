...
typedef	BOOL (__stdcall *FuncConnect)(HWND hWnd,DWORD msg,char mediaType,char userType,const char* pID,const char* pPW,const char* pCertPW);
typedef	BOOL (__stdcall *FuncQuery)(HWND hWnd,int transactionID,const char* pTrCode,const char* pInputData,int inputDataSize,int accountIndex);
typedef	BOOL (__stdcall *FuncAttach)(HWND hWnd,const char* pSiseName,const char* pInputCode,int inputCodeSize,int inputCodeTotalSize);
typedef	BOOL (__stdcall *FuncDetach)(HWND hWnd,const char* pSiseName,const char* pInputCode,int inputCodeSize,int inputCodeTotalSize);
typedef	BOOL (__stdcall *FuncDetachWindow)(HWND hWnd);
